...
import logoWsol from '@/images/logos/wsol.jpeg'
import logoWt from '@/images/logos/watchtower.png'
import logoOlo from '@/images/logos/olo.jpg'
...
function Resume() {
  ...
  return (
    <div className="rounded-2xl border border-zinc-100 p-6 dark:border-zinc-700/40">
      ...
      <Button
        href="/Ricardo_Herrera_Resume.pdf"
        variant="secondary"
      ...
      <Container className="mt-9">
        <div className="max-w-2xl">
          <h1 className="text-4xl font-bold tracking-tight text-zinc-800 sm:text-5xl dark:text-zinc-100">
            Infrastructure engineer, software developer and builder of things.
          </h1>
          <p className="mt-6 text-base text-zinc-600 dark:text-zinc-400">
            Hey! 👋 I'm Ricardo, a computer systems engineer based in New York.
            During the day, I'm an SRE and DevOps evangelist with a passion for
            automation. At night, I tinker with all things tech and pretend my
            homelab isn't getting out of control.
          </p>
          <div className="mt-6 flex gap-6">
            <SocialLink
              href="https://x.com/rickhlx"
              aria-label="Follow on X"
              icon={XIcon}
            />
            <SocialLink
              href="https://www.instagram.com/rickhlx"
              aria-label="Follow on Instagram"
              icon={InstagramIcon}
            />
            <SocialLink
              href="https://github.com/rickhlx"
